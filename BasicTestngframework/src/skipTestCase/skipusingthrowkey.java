...
public class skipusingthrowkey {
  ...
  @Test
  public void ltin1() { 
	//************* this test case will be skipped  from execution and will be displayed in the console the skipped count.
	  throw new SkipException("i want to skip this specific test case using thorw keword and print on console");
//	  String name="Tiger";
//	  
