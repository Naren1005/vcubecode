...
public class functional_textonly {
  ...
  public void titleafterlogin() throws InterruptedException {
	  driver.get("http://127.0.0.1/orangehrm-2.5.0.2/login.php");
		...
		driver.findElement(By.xpath("//input[@class ='logText' or @type='text']")).sendKeys("selenium");
		driver.findElement(By.xpath("//input[@class ='logText' or @type='password']")).sendKeys("selenium");
		Thread.sleep(2000);
		//for submit button
		driver.findElement(By.xpath("//input[@class ='buton' or @type='Submit']")).click();
		// for clear button
